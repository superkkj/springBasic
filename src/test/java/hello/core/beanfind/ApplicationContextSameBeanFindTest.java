...
//    @Test
//    @DisplayName("타입으로 조회시 같은 타입 둘이상이면 중복오류가 발생한다 ")
...
//    }
    ...
    void findBeanByName(){
        MemberRepository memberRepository = ac.getBean("memberRepositoyr1",MemberRepository.class);
    ...
    @Configuration
    static  class SameBeanConfig { //현재 클래스 안에서만쓰겟다 스테틱

        @Bean
        public MemberRepository memberRepositoyr1(){
